...
export const projectionDefs: Record<string, string> = {
  ...
  "EPSG:25833": "+proj=utm +zone=33 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // ETRS89 / UTM zone 33N
  "EPSG:25834": "+proj=utm +zone=34 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // ETRS89 / UTM zone 34N
  "EPSG:25835": "+proj=utm +zone=35 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // ETRS89 / UTM zone 35N
  "EPSG:25836": "+proj=utm +zone=36 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // ETRS89 / UTM zone 36N
  "EPSG:31467":
  ...
  "EPSG:23030": "+proj=utm +zone=30 +ellps=intl +towgs84=-87,-98,-121,0,0,0,0 +units=m +no_defs", // ED50 / UTM zone 30N (Spain)
  "EPSG:23031": "+proj=utm +zone=31 +ellps=intl +towgs84=-87,-98,-121,0,0,0,0 +units=m +no_defs", // ED50 / UTM zone 31N
  "EPSG:23032": "+proj=utm +zone=32 +ellps=intl +towgs84=-87,-98,-121,0,0,0,0 +units=m +no_defs", // ED50 / UTM zone 32N
  "EPSG:3006": "+proj=utm +zone=33 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // SWEREF99 TM (Sweden)
  ...
  "EPSG:3416": "+proj=tmerc +lat_0=0 +lon_0=115 +k=0.9996 +x_0=500000 +y_0=0 +ellps=GRS80 +units=m +no_defs", // NSIDC EASE-Grid North
  "EPSG:3577":
  ...
  "EPSG:3067": "+proj=utm +zone=35 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // ETRS89 / ETRS-TM35FIN (Finland)
  "EPSG:5514":
  ...
  "EPSG:26910": "+proj=utm +zone=10 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 10N
  "EPSG:26911": "+proj=utm +zone=11 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 11N
  "EPSG:26912": "+proj=utm +zone=12 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 12N
  "EPSG:26913": "+proj=utm +zone=13 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 13N
  "EPSG:26914": "+proj=utm +zone=14 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 14N
  "EPSG:26915": "+proj=utm +zone=15 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 15N
  "EPSG:26916": "+proj=utm +zone=16 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 16N
  "EPSG:26917": "+proj=utm +zone=17 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 17N
  "EPSG:26918": "+proj=utm +zone=18 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 18N
  "EPSG:26919": "+proj=utm +zone=19 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 19N
  "EPSG:26920": "+proj=utm +zone=20 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 20N
  "EPSG:26921": "+proj=utm +zone=21 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 21N
  "EPSG:26922": "+proj=utm +zone=22 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 22N
  "EPSG:26923": "+proj=utm +zone=23 +ellps=GRS80 +datum=NAD83 +units=m +no_defs", // NAD83 / UTM zone 23N
  ...
  "EPSG:28348": "+proj=utm +zone=48 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 48
  "EPSG:28349": "+proj=utm +zone=49 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 49
  "EPSG:28350": "+proj=utm +zone=50 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 50
  "EPSG:28351": "+proj=utm +zone=51 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 51
  "EPSG:28352": "+proj=utm +zone=52 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 52
  "EPSG:28353": "+proj=utm +zone=53 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 53
  "EPSG:28354": "+proj=utm +zone=54 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 54
  "EPSG:28355": "+proj=utm +zone=55 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 55
  "EPSG:28356": "+proj=utm +zone=56 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / MGA zone 56
  ...
  "EPSG:4214": "+proj=longlat +towgs84=-134,-48,149,0,0,0,0 +a=6378245 +b=6356863.018773047 +no_defs", // Beijing 1954
  ...
  "EPSG:5396": "+proj=utm +zone=19 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // SIRGAS 2000 / UTM zone 19S
  "EPSG:5641": "+proj=utm +zone=20 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // SIRGAS 2000 / UTM zone 20S
  "EPSG:5642": "+proj=utm +zone=21 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // SIRGAS 2000 / UTM zone 21S
  "EPSG:5643": "+proj=utm +zone=22 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // SIRGAS 2000 / UTM zone 22S
  "EPSG:5644": "+proj=utm +zone=23 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // SIRGAS 2000 / UTM zone 23S
  "EPSG:5645": "+proj=utm +zone=24 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // SIRGAS 2000 / UTM zone 24S
  "EPSG:5646": "+proj=utm +zone=25 +south +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // SIRGAS 2000 / UTM zone 25S
  ...
  "EPSG:2000": "+proj=tmerc +lat_0=0 +lon_0=9 +k=1 +x_0=3500000 +y_0=0 +ellps=bessel +units=m +no_defs", // Anguilla 1957 / British West Indies Grid
  "EPSG:2001": "+proj=tmerc +lat_0=0 +lon_0=9 +k=1 +x_0=3500000 +y_0=0 +ellps=clrk80 +units=m +no_defs", // Antigua 1943 / British West Indies Grid
  "EPSG:2236":
  ...
  "EPSG:3577":
    "+proj=aea +lat_1=-18 +lat_2=-36 +lat_0=0 +lon_0=132 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", // GDA94 / Australian Albers
  "EPSG:3825": "+proj=tmerc +lat_0=0 +lon_0=119 +k=0.9999 +x_0=250000 +y_0=0 +ellps=GRS80 +units=m +no_defs", // TWD97 / TM2 zone 119
  "EPSG:3826": "+proj=tmerc +lat_0=0 +lon_0=121 +k=0.9999 +x_0=250000 +y_0=0 +ellps=GRS80 +units=m +no_defs", // TWD97 / TM2 zone 121
  ...
  "EPSG:4807": "+proj=longlat +a=6378249.2 +b=6356515 +towgs84=-168,-60,320,0,0,0,0 +pm=paris +no_defs", // NTF (Paris)
  "EPSG:5514":
    "+proj=krovak +lat_0=49.5 +lon_0=24.83333333333333 +alpha=30.28813975277778 +k=0.9999 +x_0=0 +y_0=0 +ellps=bessel +towgs84=589,76,480,0,0,0,0 +units=m +no_defs", // S-JTSK / Krovak East North (Czech Republic)
  "EPSG:27572":
  ...
  "EPSG:4547": "+proj=tmerc +lat_0=0 +lon_0=114 +k=1 +x_0=500000 +y_0=0 +ellps=GRS80 +units=m +no_defs", // CGCS2000 / 3-degree Gauss-Kruger CM 114E
  "EPSG:3785":
